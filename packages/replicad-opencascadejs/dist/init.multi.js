...
/**
 * @taulabs/replicad-opencascadejs instance factory, pinned to the "multi" variant.
 *
...
const glueUrl = () => new URL('./replicad_multi.js', import.meta.url).href;
...
export const createInstance = async (options = {}) => {
  ...
  configureThreadPool(instance, threadCount);
  return instance;
};
